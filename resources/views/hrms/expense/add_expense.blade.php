                                ...
                                <div class="table-responsive">
                                    <div class="panel-body p25 pb10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="item" id="input002" class=" form-control"
                                                    placeholder="Item bought" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="purchase_from" id="input002"
                                                    class=" form-control" placeholder="Item bought from" required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="datepicker1" class="col-md-3 control-label"> Date of Purchase
                                            </label>
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="datepicker1"
                                                        class="select2-single form-control" name="date_of_purchase"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="amount" id="input002" class=" form-control"
