                                    ...
                                    <td>
                                        <div class='fc-event fc-event-primary' data-event="primary">
                                            ...
                                            <div class="fc-event-desc blink" id="blink">
                                                <b>{{
                                                    \Carbon\Carbon::createFromTimestamp(strtotime($meeting->date))->diffForHumans()}}
                                                </b> {{$meeting->name}}
                                            </div>
                                        </div>
                                    </td>
                ...
                <div class="section row">
                    <div class="col-xs-12">
                        <label class="field prepend-icon">
                            <textarea class="gui-textarea" id="meeting_description" placeholder="Meeting Description"
                                required></textarea>
