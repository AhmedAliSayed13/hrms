...
<body style="background-image: url('img/bg-9-full.jpg');">
    ...
    <div class="login-form">
        {!! Form::open() !!}
        <div class="top">
            <img src="{{assets('')}}assets/img/sipi_7.jpg" alt="icon" class="icon">
            <h1>Digital IP</h1>
        ...
        {{--<div class="footer-links row">
            <div class="col-xs-6"><a href="#"><i class="fa fa-external-link"></i><span style="color:#FFFFFF"> Register
                        Now</span></a></div>
            <div class="col-xs-6 text-right"><a href="#"><i class="fa fa-lock"></i><span style="color:#FFFFFF"> Forgot
                        password</span></a></div>
        </div>--}}
    </div>
</body>
