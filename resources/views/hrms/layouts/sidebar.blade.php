...
{{-- Admin Role --}}
        ...
        @if(Auth::user()->hasAnyPermission(['employee-management']))
            {{-- employee --}}
            <li>
        ...
        @endif
        @if(Auth::user()->hasAnyPermission(['client-management']))
            {{-- Clients --}}
            <li>
                <a class="accordion-toggle" href="/dashboard">
                    <span class="fa fa-user"></span>
        ...
        @endif
        @if(Auth::user()->hasAnyPermission(['project-management']))
        {{-- Projects --}}
        <li>
            <a class="accordion-toggle" href="/dashboard">
                <span class="fa fa-user"></span>
        ...
        @endif
        @if(Auth::user()->hasAnyPermission(['bank-account-management']))
            {{-- Bank Account --}}
            <li>
        ...
        @endif
        @if(Auth::user()->hasAnyPermission(['team-management']))    
            {{-- Teams --}}
            <li>
                <a class="accordion-toggle" href="/dashboard">
        ...
        @endif
        @if(Auth::user()->hasAnyPermission(['role-management']))
            {{-- Roles --}}
            <li>
                <a class="accordion-toggle" href="/dashboard">
        ...
        @endif
        @if(Auth::user()->hasAnyPermission(['asset-management']))
            {{-- Assets --}}
            <li>
                <a class="accordion-toggle" href="/dashboard">
