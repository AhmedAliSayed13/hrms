                                ...
                                <div class="table-responsive">
                                    <div class="panel-body p25 pb10">
                                        ...
                                        <div class="form-group">
                                            <label for="multiselect2" class="col-md-3 control-label">Employee Name
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control"
                                                    value="{{$training->employee->name}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                {!! Form::select('program_id', $training->programs, $training->program,
                                                ['class' => 'select2-multiple form-control select-primary']) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="datepicker1" value="{{$training->date_from}}"
                                                        class="select2-single form-control" name="date_from" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="datepicker4" value="{{$training->date_to}}"
                                                        class="select2-single form-control" name="date_to" required>
                                                </div>
                                            </div>
                                        </div>
