                                ...
                                <div class="table-responsive">
                                    <div class="panel-body p25 pb10">
                                        ...
                                        <div class="form-group">
                                            <label for="multiselect2" class="col-md-3 control-label"> Select Employees
                                            </label>
                                            <div class="col-md-6">
                                                <select id="done" class="selectpicker form-control" multiple
                                                    data-done-button="true" name="member_ids[]" required>
                                                    @foreach($emps as $emp)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="description" id="input002"
                                                    class="select2-single form-control" placeholder="description"
                                                    required>
                                            </div>
                                        </div>
